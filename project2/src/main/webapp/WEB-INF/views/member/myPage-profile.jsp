        ...
        <section class="myPage-content">
            ...
            <section class="myPage-main">
                ...
                <!-- 
                    ...
                    요청 경로 : /member/myPage/updateProfile (상대경로: 제일 뒤를 기준으로)
                 -->
                ...
                <!--
                    ...
                    1) application/x-www-form-urlencoded (기본값)
                        ...
                        /// request.getParameter("") -> String으로 반환되는 이유
                ...
                <form action="updateProfile" method="POST" name="myPage-frm" enctype="multipart/form-data"
                    ...
                    <div class="profile-image-area">
                        <c:if test="${empty loginMember.profileImage}">  <%--// el에서 empty는 null 또는 비어있음 --%>
                    ...
                    <div class="profile-btn-area">
                        ...
                        <!-- accpet 속성 : 업로드 가능한 파일의 타입을 제한하는 속성 
                             ex) *.pdf : pdf만 가능-->
