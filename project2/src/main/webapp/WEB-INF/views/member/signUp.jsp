...
<body> <!-- header는 main 안쪽에 /footer는 main 바깥에-->
    <main>
            ...
            <form action="/member/signUp" method="post" name="signUp-frm" id="signUp-frm">
                ...
                <div class="signUp-input-area">
                    <input type="text" name="memberEmail" id="memberEmail" 
                     placeholder="아이디(이메일)" maxlength="50" autocomplete="off" required
                     value="${tempMember.memberEmail}">
                     <%--//tempMember: request scope 다른 페이지로 이동하면 사라짐. --%>
                ...
                <div class="signUp-input-area">
                    <input type="password" name="memberPw" id="memberPw" 
                     placeholder="비밀번호" maxlength="20" autocomplete="off" required>  <!-- 패스워드는 autocomplete이 불가 -->
                </div>
                <div class="signUp-input-area">    
                ...
                <c:set var="addr" value="${fn:split(tempMember.memberAddress, ',,')}" />
                                            <%-- //EL은 null을 빈칸으로 처리 (nullpoint~~예외 발생 안함) --%>
                <!-- 주소 입력 -->
